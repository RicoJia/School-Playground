% Z axis: j along this axis follows the same 1D control: 
%   Minimizing its difference with the reference trajectory
%   while maintaining velocity asa ard constraint
%   hard constraint is the velocity
